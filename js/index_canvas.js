(function() {
    ...
    function initHeader() {
        ...
        for(var i in points) {
            var c = new Circle(points[i], 2+Math.random()*2, 'rgba(157,157,157,.3)');
            points[i].circle = c;
        }
    }
    ...
    function resize() {
        ...
        canvas.width = width;
        canvas.height = height;
        // canvas.width = $(".images .fll").width();
        // canvas.height = $(".images .fll").height();
    }
    ...
    function drawLines(p) {
        ...
        for(var i in p.closest) {
            ...
            ctx.strokeStyle = 'rgba(157,157,157,'+ p.active+')';
            ctx.stroke();
        }
    }
