...
//var footer = contextPath+"/indexpicture/pc/footer.htm";
//$(".ajax-footer").load(footer);
//
//var headermobile = contextPath+"/indexpicture/mobile/header.htm";
//$(".ajax-header-mobile").load(headermobile);
//
//var footermobile = contextPath+"/indexpicture/mobile/footer.htm?href="+encodeURIComponent(href);
//$(".ajax-footer-mobile").load(footermobile);

$('head').append("<link href='/views/module/web/img/favicon.ico' rel='shortcut icon'>");
